...
mat3 mat3::skew(vec2<float> radians) {
	...
	return mat3(1.f, t.x, 0.f, t.y, 1.f, 0.f, 0.f, 0.f, 1.f);
}

mat3 mat3::identity() { return mat3(1.f, 0.f, 0, 0.f, 1.f, 0, 0.f, 0.f, 1); }
mat3 mat3::translation(vec2<float> t) { return mat3(1.f, 0.f, t.x, 0.f, 1.f, t.y, 0.f, 0.f, 1.f); }
mat3 mat3::scale(vec2<float> s) { return mat3(s.x, 0.f, 0, 0.f, s.y, 0, 0.f, 0.f, 1.f); }

vec2<float> mat3::transform_point(vec2<float> p) const {
	vec2<float> const out = {
