...
struct rgba final {
	...
	[[nodiscard]] constexpr bool operator==(rgba rhs) const { return r == rhs.r && g == rhs.g && b == rhs.b && a == rhs.a; }
	[[nodiscard]] constexpr bool operator!=(rgba rhs) const { return !(*this == rhs); }
