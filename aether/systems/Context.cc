...
// private
Context::Context(Window& window_ref, Renderer& renderer_ref, TextureRepo& texture_repo_ref,
                 TextureAtlasRepo& texture_atlas_repo_ref, Director& director_ref)
    : window(window_ref), renderer(renderer_ref), texture_repo(texture_repo_ref),
