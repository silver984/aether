...
mat3::mat3() : m{{1.f, 0.f, 0.f},
				 {0.f, 1.f, 0.f},
				 {0.f, 0.f, 1.f}} {}

mat3::mat3(float m00, float m01, float m02,
		   float m10, float m11, float m12,
		   float m20, float m21, float m22) : m{{m00, m01, m02},
												{m10, m11, m12},
												{m20, m21, m22}} {}
...
mat3 mat3::skew(vec2<float> radians) {
	vec2<float> tan = {std::tan(radians.x),
					   std::tan(radians.y)};

	return mat3(1.f, tan.x, 0.f,
				tan.y, 1.f, 0.f,
				0.f, 0.f, 1.f);
}
...
vec2<float> mat3::transform_point(vec2<float> p) const {
	return {p.x * m[0][0] + p.y * m[0][1] + m[0][2],
